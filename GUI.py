...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBox.setGeometry(QtCore.QRect(220, 290, 79, 23))
        ...
        self.label.setGeometry(QtCore.QRect(600, 260, 181, 31))
        ...
        self.pushButton.setGeometry(QtCore.QRect(80, 540, 80, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.pushButton_2 = QtGui.QPushButton(self.centralwidget)
        self.pushButton_2.setGeometry(QtCore.QRect(690, 530, 121, 41))
...
""))
        ...
        self.radioButton.setGeometry(QtCore.QRect(670, 170, 100, 21))
        self.radioButton.setObjectName(_fromUtf8("radioButton"))
        self.radioButton_2 = QtGui.QRadioButton(self.centralwidget)
        self.radioButton_2.setGeometry(QtCore.QRect(670, 190, 100, 21))
        ...
        self.label_8.setGeometry(QtCore.QRect(670, 140, 181, 16))
        ...
        self.label_12.setGeometry(QtCore.QRect(40, 510, 211, 16))
        self.label_12.setObjectName(_fromUtf8("label_12"))
        self.textBrowser = QtGui.QTextBrowser(self.centralwidget)
        self.textBrowser.setGeometry(QtCore.QRect(550, 300, 301, 171))
        self.textBrowser.setObjectName(_fromUtf8("textBrowser"))
        self.label_13 = QtGui.QLabel(self.centralwidget)
        self.label_13.setGeometry(QtCore.QRect(100, 260, 351, 16))
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(450, 180, 91, 21))
        self.pushButton_3.setObjectName(_fromUtf8("pushButton_3"))
        self.label_14 = QtGui.QLabel(self.centralwidget)
        self.label_14.setGeometry(QtCore.QRect(390, 140, 221, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(10, _translate("MainWindow", "airspeed", None))
        self.comboBox.setItemText(11, _translate("MainWindow", "vel", None))
        self.comboBox.setItemText(12, _translate("MainWindow", "go", None))
        ...
        self.label_11.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">0 parameter :</span></p></body></html>", None))
        self.label_12.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-style:italic; color:#00007f;\">CLICK TO LAUNCH THE MISSION</span></p></body></html>", None))
        self.label_13.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-style:italic; color:#00007f;\">SELECT THE COMMAND, ENTER PARAMETERS AND SEND</span></p></body></html>", None))
        self.pushButton_3.setText(_translate("MainWindow", "is_armable", None))
        self.label_14.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-style:italic; color:#00007f;\">CHECK IF THE VEHICLE IS ARMABLE</span></p></body></html>", None))
